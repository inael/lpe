...
function $oat(something) {              //Retorna objeto de referencia getElementById para um ou para uma coleção de objetos
...
function $v(something) {        //Retorna o value de um objeto se existir, senão retorna um false
	var e = $oat(something);
	if (!e) return false;
...
OAT.Dom = { /* DOM common object */
    create: function (tagName, styleObj, className, idName) {
