...
{
    /// <summary>
    /// Classe de Persistência da entidade Questionario
    /// </summary>
    public class QuestionarioDao : Crud<Questionario>
    {
        #region Construtores
        ...
        {
            List<Questionario> lista = Contexto.Listar().ToList();
            return lista;
        }
        ...
        public Questionario Consultar(int id)
        {
            Questionario entidade = Contexto.Consultar(a => a.IdQuestionario == id);
            return entidade;
        }
        ...
        public Questionario Incluir(Questionario entidade)
        {
        ...
        {
            List<Questionario> lista = Contexto.Listar(a => a.Excluido == false).ToList();
            return lista;
        }
