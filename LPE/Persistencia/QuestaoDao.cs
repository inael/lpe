...
{
    /// <summary>
    /// Classe de Persistência da entidade Questao
    /// </summary>
    public class QuestaoDao : Crud<Questao>
    {
        #region Construtores
        ...
        {
            List<Questao> lista = Contexto.Listar().ToList();
            return lista;
        }
        ...
        {
            Questao entidade = Contexto.Consultar(a => a.IdQuestao == id);
            return entidade;
        }
        ...
        public Questao Incluir(Questao entidade)
        {
        ...
        {
            List<Questao> lista = Contexto.Listar(a => a.Excluido == false).ToList();
            return lista;
        }
