...
{
    /// <summary>
    /// Classe de Persistência da entidade Pessoa
    /// </summary>
    public class PessoaDao : Crud<Pessoa>
    {
        #region Construtores
        ...
        {
            List<Pessoa> lista = Contexto.Listar().ToList();
            return lista;
        }
        ...
        {
            Pessoa entidade = Contexto.Consultar(a => a.IdPessoa == id);
            return entidade;
        }
        ...
        public Pessoa Incluir(Pessoa entidade)
        {
        ...
        {
            List<Pessoa> lista = Contexto.Listar(a => a.Excluido == false).ToList();
            return lista;
        }
