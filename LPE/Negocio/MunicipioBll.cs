...
{
    /// <summary>
    /// Classe de negócio da entidade: Municipio
    /// </summary>
    public class MunicipioBll
    {
        #region Campos privados

        MunicipioDao persistencia;
        ...
        {
            List<Municipio> lista = persistencia.Listar();
            return lista;
        }
        ...
        {
            Municipio entidade = persistencia.Consultar(id);
            return entidade;
        }
        ...
        public Municipio Inserir(Municipio entidade)
        {
            //entidade.UsuarioInclusao = Sess
        ...
        {
            Municipio entidadeConsulta = this.Consultar(entidade.IdMunicipio);
        ...
        {
            List<Municipio> lista = persistencia.ListarAtivos();
            return lista;
        }
